...
if (!$arTegs['north']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = '/kupit-dom/dmitrovskoe-shosse/kupit-uchastok/';
            break;
        case 'withDom': // Дома
            $urlTeg = '/kupit-dom/dmitrovskoe-shosse/kupit-dom/';
            break;
        default: // Поселки
            $urlTeg = '/kupit-dom/dmitrovskoe-shosse/';
            break;
    }
...
if (!$arTegs['east']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = '/kupit-dom/novoryazanskoe-shosse/kupit-uchastok/';
            break;
        case 'withDom': // Дома
            $urlTeg = '/kupit-dom/novoryazanskoe-shosse/kupit-dom/';
            break;
        default: // Поселки
            $urlTeg = '/kupit-dom/novoryazanskoe-shosse/';
            break;
    }
...
if (!$arTegs['south']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = '/kupit-dom/simferopolskoe-shosse/kupit-uchastok/';
            break;
        case 'withDom': // Дома
            $urlTeg = '/kupit-dom/simferopolskoe-shosse/kupit-dom/';
            break;
        default: // Поселки
            $urlTeg = '/kupit-dom/simferopolskoe-shosse/';
            break;
    }
...
if (!$arTegs['west']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = '/kupit-dom/novorijskoe-shosse/kupit-uchastok/';
            break;
        case 'withDom': // Дома
            $urlTeg = '/kupit-dom/novorijskoe-shosse/kupit-dom/';
            break;
        default: // Поселки
            $urlTeg = '/kupit-dom/novorijskoe-shosse/';
            break;
    }
...
if (!$arTegs['kashirskoe']['url']) {
    switch ($domPos) {
        ...
        case 'withDom': // Дома
            ...
            break;
        default: // Поселки
            $urlTeg = '/kupit-dom/kashirskoe-shosse/';
            break;
    }
...
for ($i = 10; $i < 60; $i += 10) { // до МКАД
    ...
    if (!$arTegs['mkad_' . $i]['url']) {
        switch ($domPos) {
            case 'noDom': // Участки
                $urlTeg = '/kupit-dom/kupit-uchastok-do-' . $i . '-km-ot-mkad/';
                break;
            case 'withDom': // Дома
                $urlTeg = '/kupit-dom/kupit-dom-dachu-kottedzh-do-' . $i . '-km-ot-mkad/';
                break;
            default: // Поселки
                $urlTeg = '/kupit-dom/do-' . $i . '-km-ot-mkad/';
                break;
        }
...
if (!$arTegs['gaz']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-s-gazom/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-s-gazom/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/s-gazom/";
            break;
    }
...
if (!$arTegs['elektro']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-s-elektrichestvom/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-s-elektrichestvom/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/s-elektrichestvom/";
            break;
    }
...
if (!$arTegs['izhs']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-izhs/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-izhs/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/izhs/";
            break;
    }
...
if (!$arTegs['snt']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-snt/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-snt/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/snt/";
            break;
    }
...
if (!$arTegs['ryadom-s-lesom']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-ryadom-s-lesom/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-ryadom-s-lesom/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/ryadom-s-lesom/";
            break;
    }
...
if (!$arTegs['u-vody']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-u-vody/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-u-vody/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/u-vody/";
            break;
    }
...
if (!$arTegs['econom']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-econom-class/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-econom-class/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/econom-class/";
            break;
    }
...
if (!$arTegs['komfort']['url']) {
    switch ($domPos) {
        case 'noDom': // Участки
            $urlTeg = "/kupit-dom/kupit-uchastok-komfort-class/";
            break;
        case 'withDom': // Дома
            $urlTeg = "/kupit-dom/kupit-dom-komfort-class/";
            break;
        default: // Поселки
            $urlTeg = "/kupit-dom/komfort-class/";
            break;
    }
...
// какие теги выводить
if (!$arTegsShow) $arTegsShow = ['kashirskoe', 'north', 'east', 'south', 'west', 'mkad_30', 'mkad_50', 'gaz'];
// dump($arTegsShow);
