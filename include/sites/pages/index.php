  ...
  <div class="container">
    ...
    <div class="card">
      <div class="row card__row">
							...
							<a href="<?=$planIMG_2?>" data-fancybox <?=$frame_2?>>
								<picture>
									<source type="image/webp" srcset="<?=$planIMG_2_res['src']?>">
										<img src="<?=$planIMG_2_res['src']?>" alt="План и цены КП <?=$villageLink['NAME']?>" title="План и цены поселок <?=$villageLink['NAME']?>" loading="lazy" decoding="async">
								</picture></a>
						</div>
					</div>
				</div>
		...
		<?}elseif($planIMG2):?>
			<h2 class="title--size_2 section-title page__title">План и цены “<?=$arVillage['NAME']?> 2”</h2>
			<div class="card">
	      <div class="row card__row">
	        <div class="row__col-12 card__col-picture">
						<div class="card__picture">
            ...
            <div class="review__desc">
              ...
              <div class="review__text">
                ...
                <p><?=$comment["TEXT"]?></p>
						...
						<?if(SITE_TEMPLATE_PATH == '/local/templates/kalipso_3'):?>
