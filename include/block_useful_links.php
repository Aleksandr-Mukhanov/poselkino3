    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="useful-links__card">
          ...
          <ul class="useful-links__list">
            <li class="useful-links__item">
              <a href="/kupit-uchastki/kashirskoe-shosse/" class="useful-links__link">Каширское</a>
            </li>
            <li class="useful-links__item">
              <a href="/kupit-uchastki/dmitrovskoe-shosse/" class="useful-links__link">Дмитровское</a>
            </li>
            <li class="useful-links__item">
              <a href="/kupit-uchastki/novoryazanskoe-shosse/" class="useful-links__link">Новорязанское</a>
            </li>
          </ul>
        </div>
      </div>
