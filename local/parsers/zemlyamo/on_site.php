...
$parserName = 'zemlyamo';
$siteName = 'zemlyamo.ru';
$xmlDeveloper = 'Zemlya-MO';
    ...
    if ($arVillageInfo[0])
		{
			...
			if ($arVillageInfo[0] == 'Beketovo Park') $arVillageInfo[0] = 'Бекетово Парк';
			if ($arVillageInfo[0] == 'Shelkovo Forest') $arVillageInfo[0] = 'Шелково Форест';
			if ($arVillageInfo[0] == 'White Park') $arVillageInfo[0] = 'Уайт Парк';
			if ($arVillageInfo[0] == 'Panorama River') $arVillageInfo[0] = 'Панорама Ривер';
			if ($arVillageInfo[0] == 'Greenwood') $arVillageInfo[0] = 'Гринвуд-2';
			if ($arVillageInfo[0] == 'Green Park') $arVillageInfo[0] = 'Грин Парк';
...
if ($arVillageNames)
{
  ...
  while($arElement = $rsElements->Fetch())
	...
	foreach ($arPlotFeed as $plotFeed) // перебираем участки из фида
	{
		...
		if ($villageCode == 'white-park') $villageCode = 'vayt-park';
		if ($villageCode == 'greenwood') $villageCode = 'grinvud-2';
