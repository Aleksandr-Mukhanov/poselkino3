...
<div class="bg-white page-va-list__info">
	...
	<div class="container pt-0 pt-sm-3 pt-md-5">
		<div class="row align-items-center">
			<?// получим свой H1
				$arOrder = Array("SORT"=>"ASC");
				$arFilter = Array("IBLOCK_ID"=>3,'CODE'=>$arResult["VARIABLES"]["SECTION_CODE"]);
				$arSelect = Array("ID","UF_H1");
				$rsSections = CIBlockSection::GetList($arOrder,$arFilter,false,$arSelect,false);
				while($arSection = $rsSections->GetNext()){
					$section_H1 = $arSection['UF_H1'];
				}
			?>
			<div class="col-12 mt-0 mb-3">
				<h1 class="my-0 title"><?=($section_H1)?$section_H1:$APPLICATION->ShowTitle(false)?></h1>
			</div>
			<?$APPLICATION->IncludeComponent(
				"bitrix:news.list",
				"blog",
