...
// dump($arResult["ITEMS"]);
?>
	<form class="row hero__form" name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get">
		...
		<div class="form-wrap">
			<div class="col-6 col-sm-4 col-md-2 col-xl-2 pr-2 pr-xl-3 col-type">
				...
				<select id="filter-type" class="select-bg-white changeTypeSelect">
					...
					<option class="house-modal" value="arrFilter_2_4088798008" <?if($arResult["ITEMS"][2]["VALUES"][4]['CHECKED'])echo "selected";?>>Дом</option>
					<option value="arrFilter_2_1842515611" <?if($arResult["ITEMS"][2]["VALUES"][3]['CHECKED'])echo "selected";?>>Участок</option>
				</select>
			</div>
			<div class="col-6 col-sm-5 col-md-2 col-xl-1 pl-2 pl-xl-3 pr-xl-0">
				...
				<button class="btn btn-outline-warning rounded-pill w-100 Highway <?=$activeHighway?>" type="button" data-toggle="modal" data-target="#highwayModal">Шоссе</button>
			</div>
			...
			<div class="col-12 col-sm-4 col-md-3 col-xl-4 col-inline">
				<div class="form-group form-group-inline">
					<label>Стоимость<span class="rub d-xl-none">, a</span></label>
				</div>
				<div class="cost_land">
					<div class="row">
				...
				<span class="d-none d-xl-flex right-text desktop-rub"><span class="rub">a</span></span>
			</div>
			<div class="col-12 col-sm-4 col-md-2 pl-sm-0">
				<input class="btn btn-warning w-100" type="submit" id="set_filter" name="set_filter" value="Подобрать" disabled>
			</div>
		</div>
		<div class="col-12">
			<button class="w-100 btn btn-secondary other-parameters rounded-pill" type="button" data-toggle="modal" data-target="#searchParamsModal">Дополнительные параметры</button>
		</div>
						...
						<div class="filter row">
									...
									<div class="row">
										<div class="col-lg-8 mt-40">
										    ...
										    <?endforeach;?>
												...
												<?endforeach;?>
												<div class="custom-control custom-checkbox custom-control-inline align-items-center h-100">
													<input class="custom-control-input" id="extraOptionsTypeIP" type="checkbox" name="extraOptionsTypeIP">
													<label class="custom-control-label" for="extraOptionsTypeIP">Доступна рассрочка</label>
												</div>
											</div>
										</div>
									</div>
									<div class="row extra-options__parameters">
								      ...
								      endforeach;?>
										...
										<div class="order-sm-4 col-sm-4 order-md-3 order-lg-5 order-xl-4 col-md-3 col-lg-2">
									      ...
									      <?endif;
									      endforeach;?></div>
												<input class="sr-only iconDouble" type="checkbox" id="vodoem" data-id1="<?=$arResult["ITEMS"][47]["VALUES"][39]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][47]["VALUES"][40]["CONTROL_ID"]?>" data-id3="<?=$arResult["ITEMS"][47]["VALUES"][41]["CONTROL_ID"]?>">
									      ...
									      <?endif;
									      endforeach;?></div>
												<input class="sr-only iconDouble" type="checkbox" id="les" data-id1="<?=$arResult["ITEMS"][45]["VALUES"][35]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][45]["VALUES"][36]["CONTROL_ID"]?>" data-id3="<?=$arResult["ITEMS"][45]["VALUES"][37]["CONTROL_ID"]?>" data-id4="<?=$arResult["ITEMS"][45]["VALUES"][38]["CONTROL_ID"]?>">
												...
												<div class="col-sm-6 col-lg-12 col-xl-6">
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][81]["VALUES"] as $val => $ar): //dump($ar); // Магазин?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="magazin" data-id1="<?=$arResult["ITEMS"][81]["VALUES"][72]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][81]["VALUES"][113]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][83]["VALUES"] as $val => $ar): //dump($ar); // Церковь?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="cerkov" data-id1="<?=$arResult["ITEMS"][83]["VALUES"][76]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][83]["VALUES"][115]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][84]["VALUES"] as $val => $ar): //dump($ar); // Школа?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="school" data-id1="<?=$arResult["ITEMS"][84]["VALUES"][78]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][84]["VALUES"][116]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][85]["VALUES"] as $val => $ar): //dump($ar); // Дет.сад?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="detsad" data-id1="<?=$arResult["ITEMS"][85]["VALUES"][80]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][85]["VALUES"][117]["CONTROL_ID"]?>">
												...
												<div class="col-sm-6 col-lg-12 col-xl-6">
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][87]["VALUES"] as $val => $ar): // dump($val); // Кафе?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="cafe" data-id1="<?=$arResult["ITEMS"][87]["VALUES"][84]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][87]["VALUES"][119]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][88]["VALUES"] as $val => $ar): //dump($ar); // АЗС?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="azs" data-id1="<?=$arResult["ITEMS"][88]["VALUES"][86]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][88]["VALUES"][120]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][82]["VALUES"] as $val => $ar): //dump($ar); // Аптека?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="apteka" data-id1="<?=$arResult["ITEMS"][82]["VALUES"][74]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][82]["VALUES"][114]["CONTROL_ID"]?>">
													...
													<div class="extra-options__parameters-input">
														<div class="hide"><?foreach($arResult["ITEMS"][86]["VALUES"] as $val => $ar): //dump($ar); // Строймат?>
															...
															/> <?=$ar["VALUE"];?>
											      <?endforeach;?></div>
														<input class="sr-only iconDouble" type="checkbox" id="stroimat" data-id1="<?=$arResult["ITEMS"][86]["VALUES"][82]["CONTROL_ID"]?>" data-id2="<?=$arResult["ITEMS"][86]["VALUES"][118]["CONTROL_ID"]?>">
							...
							<div class="order-3 order-lg-6 col-12 mt-4 pt-1">
								<div class="d-flex flex-wrap justify-content-start">
									...
									<button class="btn btn-link filter__button-clear p-0" type="reset" onclick="smartFilter.click(this)">
		          ...
		          foreach($arResult["ITEMS"][5]["VALUES"] as $val => $ar){
		            ...
		            switch ($ar['URL_ID']) {
		              ...
		              default: $arShosse['other']['SHOSSE'][] = $ar; break;
			            ...
			            <div class="highway-block__title chart" onclick="smartFilter.click(this)"><?=$value['NAME']?></div>
