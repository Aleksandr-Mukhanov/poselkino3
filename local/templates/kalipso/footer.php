<?if(!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true)die();?>
  ...
  <input type="hidden" id="develInfo" data-idDevel='<?=$arDevel[0]['ID']?>' data-nameDevel='<?=$arDevel[0]['UF_NAME']?>' data-codeDevel='<?=$arDevel[0]['UF_XML_ID']?>' data-phoneDevel='<?=$arDevel[0]['UF_PHONE']?>'>
    <footer class="footer">
      <div class="container footer__container">
        <div class="row footer__row footer-top">
          ...
          <div class="row__col-3 footer__col-contacts"><a class="phone" href="tel:<?=str_replace(['','(',')','-'],'',$arDevel[0]['UF_PHONE'])?>"><span class="icon-phone phone__icon"></span> <?=$arDevel[0]['UF_PHONE']?></a>
