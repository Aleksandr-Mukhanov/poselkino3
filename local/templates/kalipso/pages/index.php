...
$APPLICATION->SetPageProperty("title", "Коттеджный поселок ".$arVillage['NAME'].", ".$regionName." район - официальный сайт дилера");
$APPLICATION->SetPageProperty("description", "Купить участок в КП ".$arVillage['NAME']." от ".formatPriceSite($arVillage['PROPERTY_PRICE_SOTKA_VALUE'][0])." руб. за сотку. ".$shosseName." шоссе, ".$arVillage['PROPERTY_MKAD_VALUE']." км от МКАД. ИЖС, охрана, свет, газ, ".$regionName." район");
// узнаем отзывы
    ...
    <div class="row">
      ...
      <div class="col-lg col-md-6">
        <div class="infrastructure-item">
          ...
          <div class="infrastructure-item__name">Индивидуальное <br>жилищное строительство</div>
        </div>
      </div>
      <div class="col-lg col-md-6">
        <div class="infrastructure-item">
      ...
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-6">
          <div class="b2_card__main">
            ...
            <a class="phone phone--b2" href="tel:<?=str_replace(['','(',')','-'],'',$arDevel[0]['UF_PHONE'])?>"><span class="icon-phone phone__icon"></span> <?=$arDevel[0]['UF_PHONE']?></a>
          </div>
        </div>
      </div>
    </div>
...
<section class="advantages advantages--2">
  <div class="container">
    ...
    <div class="center"><a class="btn btn--large btn--theme_blue" href="/infrastruktura/">Узнать подробнее</a></div>
  </div>
</section>
      ...
      <div class="row card__row">
        ...
        <div class="row__col-5 card__col-content">
          <div class="card__content">
            ...
            <div class="d-none d-xl-block"><a class="btn btn--large btn--theme_blue" href="/plan-i-ceny/">Узнать подробнее</a></div>
          </div>
        </div>
      </div>
    </div>
    <div class="d-block d-xl-none">
      <div class="center"><a class="btn btn--large btn--theme_blue" href="/plan-i-ceny/">Узнать подробнее</a></div>
    </div>
  </div>
</section>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="ecology"><img src="<?=SITE_TEMPLATE_PATH?>/images/ecology-3.jpg" alt="">
          <div class="ecology__main">
            ...
            <div class="ecology__type"><?=$arWater?></div>
      ...
      <div class="col-md-6 col-lg-3">
        <div class="ecology"><img src="<?=SITE_TEMPLATE_PATH?>/images/ecology-4.jpg" alt="">
          <div class="ecology__main">
            ...
            <div class="ecology__type"><?=$arSoil?></div>
          </div>
        </div>
      </div>
    </div>
...
<section class="location">
  <div class="container">
    ...
    <div class="row mb-4">
      ...
      <div class="col-md-4">
        <div class="get_item">
          ...
          <div class="get_item__content">
            <div class="get_item__title">На элетричке <?=$arVillage['PROPERTY_TRAIN_TRAVEL_TIME_VALUE'] // Электричка (время в пути)?></div>
          </div>
        </div>
      </div>
      <div class="col-md-4">
    ...
    <div class="center"><a class="btn btn--large btn--theme_blue" href="/na-karte/">Узнать подробнее</a></div>
  </div>
</section>
