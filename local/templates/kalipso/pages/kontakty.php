...
$APPLICATION->SetPageProperty("description", "Телефон офиса продаж ".$arDevel[0]['UF_PHONE'].", адрес поселка: ".$regionName." район, рядом с ".$arVillage['PROPERTY_SETTLEM_VALUE'].". Офис продаж: ".$arDevel[0]['UF_ADDRESS'].".");?>
<section class="page">
    ...
    <div class="contacts row">
      <div class="col-lg-4">
        <div class="contacts__info" itemscope itemtype="http://schema.org/Organization">
          <p itemprop="name">ООО «<?=$arDevel[0]['UF_NAME']?>»</p>
          ...
          <div class="contacts-item">
            <div class="mb-1">
              <a class="contacts-phone" href="tel:<?=str_replace(['','(',')','-'],'',$arDevel[0]['UF_PHONE'])?>" itemprop="telephone"><?=$arDevel[0]['UF_PHONE']?></a>
            </div>
