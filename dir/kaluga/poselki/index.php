...
$APPLICATION->SetPageProperty("title", "Коттеджные поселки в ".REGION_KOY." области - ".getMetaInfo($arrFilter)['cntPos']." объявлений");
$APPLICATION->SetPageProperty("description", "★★★ Коттеджные поселки в ".REGION_KOY." области ➤Цены от ".getMetaInfo($arrFilter)['minPrice']." руб. ➤Кол-во объявлений - ".getMetaInfo($arrFilter)['cntPos']." ✔Стоимость коммуникаций ✔Актуальные фото ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Независимый рейтинг ✔Честный обзор");
