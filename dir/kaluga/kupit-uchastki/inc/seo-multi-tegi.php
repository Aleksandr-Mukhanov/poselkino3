...
if ($shosse && $mkadKM)
{
  $newH1 = 'Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от КАД';
  $newTitle = 'Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от КАД';
  $newDesc = '▶Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от КАД ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
}
...
if ($rayon && $mkadKM)
{
  $newH1 = 'Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от КАД';
  $newTitle = 'Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от КАД';
  $newDesc = '▶Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от КАД ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
...
if ($mkadKM && $typeURL)
{
  $newH1 = 'Земельные участки '.$inChainItem.' до '.$mkadKM.' км от КАД';
  $newTitle = 'Земельные участки '.$inChainItem.' до '.$mkadKM.' км от КАД';
  $newDesc = '▶Земельные участки '.$inChainItem.' районе до '.$mkadKM.' км от КАД ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
