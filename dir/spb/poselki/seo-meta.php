...
if($arRes = $rsData->Fetch()){ // dump($arRes);
  ...
  if(is_numeric($mkadKM)){
    ...
    $newDesc = '▶Коттеджные поселки в '.$mkadKM.' км от МКАД ▶ Полная база коттеджных поселков и коттеджей на расстоянии до '.$mkadKM.' км от Санкт-Петербурга ★★★ Независимый рейтинг  ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
...
if(is_numeric($mkadKM) && $domPos){ // если выбор км до МКАД и участок/дом
  switch ($domPos) {
    case 'noDom': // Участки
      ...
      $newDesc = '▶Купить землю в '.$mkadKM.' км от МКАД ▶ Полная база земельных участков на расстоянии до '.$mkadKM.' км от Санкт-Петербурга ★★★ Независимый рейтинг  ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
    ...
    case 'withDom': // Дома
      ...
      $newDesc = '▶Купить дома в '.$mkadKM.' км от МКАД ▶ Полная база домов на расстоянии до '.$mkadKM.' км от Санкт-Петербурга ★★★ Независимый рейтинг  ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
