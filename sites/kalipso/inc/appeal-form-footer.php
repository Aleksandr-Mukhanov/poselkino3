...
<section class="appeal">
  <div class="container appeal__container">
    <h2 class="title--size_2 appeal__title">Забронировать участок</h2>
    <form class="appeal-form formSignToView" action="/local/ajax/sendForm.php" method="post">
      <div class="title--size_4 appeal-form__title">Позвоните по телефону <a href="tel:<?=str_replace(['','(',')','-'],'',$arDevel[0]['UF_PHONE'])?>"><strong><?=$arDevel[0]['UF_PHONE']?></strong></a>, или заполните форму ниже</div>
