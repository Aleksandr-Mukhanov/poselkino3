...
if ($shosse && $mkadKM)
{
  $newH1 = 'Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от '.ROAD;
  $newTitle = 'Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от '.ROAD;
  $newDesc = '▶Земельные участки на '.$arNames['NAME_KOM'].' шоссе до '.$mkadKM.' км от '.ROAD.' ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
}
...
if ($rayon && $mkadKM)
{
  $newH1 = 'Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от '.ROAD;
  $newTitle = 'Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от '.ROAD;
  $newDesc = '▶Земельные участки в '.$arNames['NAME_KOM'].' районе до '.$mkadKM.' км от '.ROAD.' ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
...
{
  $newH1 = 'Земельные участки '.$inChainItem.' до '.$mkadKM.' км от '.ROAD;
  $newTitle = 'Земельные участки '.$inChainItem.' до '.$mkadKM.' км от '.ROAD;
  $newDesc = '▶Земельные участки '.$inChainItem.' районе до '.$mkadKM.' км от '.ROAD.' ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;

}
elseif ($mkadKM && $commun)
{
  $newH1 = 'Земельные участки '.$communTxt.' до '.$mkadKM.' км от '.ROAD;
  $newTitle = 'Земельные участки '.$communTxt.' до '.$mkadKM.' км от '.ROAD;
  $newDesc = '▶Земельные участки '.$communTxt.' районе до '.$mkadKM.' км от '.ROAD.' ▶ Независимый рейтинг! ✔Видео с квадрокоптера ✔Экология местности ✔Отзывы покупателей ✔Юридическая чистота ✔Стоимость коммуникаций!';
  $onlyParam = true;
